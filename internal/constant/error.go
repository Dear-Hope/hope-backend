...
// Error package auth
var (
	ErrorUserAlreadyExists      = "user with this email address already exists"
	ErrorCreateUserFailed       = "failed to create user"
	ErrorGenerateToken          = "failed to generate token"
	ErrorGenerateOtpCode        = "failed to generate otp code"
	ErrorUserNotFound           = "user not found with"
	ErrorGetUserFailed          = "failed to get user"
	ErrorPasswordNotMatch       = "password does not match"
	ErrorAccountNotVerified     = "account has not been verified yet"
	ErrorVerifyUserFailed       = "failed to verify user"
	ErrorOtpCodeExpired         = "your verification code has expired"
	ErrorAccountAlreadyVerified = "account has already been verified"
	ErrorResendLimitReached     = "resend limit reached, please try again after a while"
	ErrorChangePasswordFailed   = "failed to change user password"
